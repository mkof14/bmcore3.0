  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-md border border-[var(--bm-border)] bg-[var(--bm-surface)] text-sm font-medium text-gray-800 transition-colors hover:border-orange-500/40 dark:text-neutral-100 ${
